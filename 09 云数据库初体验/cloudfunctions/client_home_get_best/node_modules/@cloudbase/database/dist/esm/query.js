...
import { getReqOpts, stringifyByEJSON, preProcess, processReturn, transformDbObjFromNewToOld } from './utils/utils';
...
export class Query {
    ...
    where(query) {
        ...
        return new Query(this._db, this._coll, QuerySerializer.encodeEJSON(query), this._apiOptions, this._oldInstance.where(transformDbObjFromNewToOld(query, this._db._oldDbInstance, [query])));
    }
    options(apiOptions) {
